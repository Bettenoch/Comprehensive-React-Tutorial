...
**[Math Magician]** wMath magicians" is a website for user with daily activities. It is a Single Page App (SPA) that allows users to:
...
- **[Add and delete todo items from the list.]**
